...
public class EcoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EcorePackage.SEMESTER_IN_STUDYPLAN: {
				SemesterInStudyplan semesterInStudyplan = (SemesterInStudyplan)theEObject;
				T result = caseSemesterInStudyplan(semesterInStudyplan);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EcorePackage.ELECTIVE: {
				Elective elective = (Elective)theEObject;
				T result = caseElective(elective);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Semester In Studyplan</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Semester In Studyplan</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSemesterInStudyplan(SemesterInStudyplan object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Elective</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Elective</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseElective(Elective object) {
		return null;
	}
