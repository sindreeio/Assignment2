...
public interface EcorePackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Semester In Programme</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Semester In Specialisation</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the '{@link ecore.impl.DepartmentImpl <em>Department</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ecore.impl.DepartmentImpl
	 * @see ecore.impl.EcorePackageImpl#getDepartment()
	 * @generated
	 */
	int DEPARTMENT = 9;

	/**
	 * The feature id for the '<em><b>Studyprogramme</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DEPARTMENT__STUDYPROGRAMME = 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link ecore.Programme#getSemesterInProgramme <em>Semester In Programme</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Semester In Programme</em>'.
	...
	/**
	 * Returns the meta object for the containment reference list '{@link ecore.Specialisation#getSemesterInSpecialisation <em>Semester In Specialisation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Semester In Specialisation</em>'.
	...
	/**
	 * Returns the meta object for the containment reference '{@link ecore.SemesterInStudyplan#getSemester <em>Semester</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link ecore.Elective#getCourse <em>Course</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link ecore.Department <em>Department</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Department</em>'.
	 * @see ecore.Department
	 * @generated
	 */
	EClass getDepartment();

	/**
	 * Returns the meta object for the containment reference list '{@link ecore.Department#getStudyprogramme <em>Studyprogramme</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Studyprogramme</em>'.
	 * @see ecore.Department#getStudyprogramme()
	 * @see #getDepartment()
	 * @generated
	 */
	EReference getDepartment_Studyprogramme();

	/**
	 * Returns the meta object for the attribute '{@link ecore.Department#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see ecore.Department#getName()
	 * @see #getDepartment()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link ecore.Department#getCourses <em>Courses</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Courses</em>'.
	 * @see ecore.Department#getCourses()
	 * @see #getDepartment()
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Semester In Programme</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Semester In Specialisation</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '{@link ecore.impl.DepartmentImpl <em>Department</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ecore.impl.DepartmentImpl
		 * @see ecore.impl.EcorePackageImpl#getDepartment()
		...
		/**
		 * The meta object literal for the '<em><b>Studyprogramme</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference DEPARTMENT__STUDYPROGRAMME = eINSTANCE.getDepartment_Studyprogramme();
