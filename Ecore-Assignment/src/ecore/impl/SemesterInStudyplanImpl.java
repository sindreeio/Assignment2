...
public class SemesterInStudyplanImpl extends MinimalEObjectImpl.Container implements SemesterInStudyplan {
	...
	public NotificationChain basicSetSemester(Semester newSemester, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EcorePackage.SEMESTER_IN_STUDYPLAN__SEMESTER, oldSemester, newSemester);
	...
	public void setSemester(Semester newSemester) {
		if (newSemester != semester) {
			NotificationChain msgs = null;
			if (semester != null)
				msgs = ((InternalEObject)semester).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EcorePackage.SEMESTER_IN_STUDYPLAN__SEMESTER, null, msgs);
			if (newSemester != null)
				msgs = ((InternalEObject)newSemester).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EcorePackage.SEMESTER_IN_STUDYPLAN__SEMESTER, null, msgs);
			msgs = basicSetSemester(newSemester, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.SEMESTER_IN_STUDYPLAN__SEMESTER, newSemester, newSemester));
	}
