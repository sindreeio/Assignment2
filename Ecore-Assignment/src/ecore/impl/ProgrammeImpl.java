...
public class ProgrammeImpl extends MinimalEObjectImpl.Container implements Programme {
	...
	/**
	 * The cached value of the '{@link #getSemesterInProgramme() <em>Semester In Programme</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<Semester> getSemesterInProgramme() {
		if (semesterInProgramme == null) {
			semesterInProgramme = new EObjectContainmentEList<Semester>(Semester.class, this, EcorePackage.PROGRAMME__SEMESTER_IN_PROGRAMME);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case EcorePackage.PROGRAMME__SEMESTER_IN_PROGRAMME:
				return ((InternalEList<?>)getSemesterInProgramme()).basicRemove(otherEnd, msgs);
		}
