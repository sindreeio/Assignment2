...
public class SpecialisationImpl extends MinimalEObjectImpl.Container implements Specialisation {
	/**
	 * The cached value of the '{@link #getSemesterInSpecialisation() <em>Semester In Specialisation</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<Semester> getSemesterInSpecialisation() {
		if (semesterInSpecialisation == null) {
			semesterInSpecialisation = new EObjectContainmentEList<Semester>(Semester.class, this, EcorePackage.SPECIALISATION__SEMESTER_IN_SPECIALISATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case EcorePackage.SPECIALISATION__SEMESTER_IN_SPECIALISATION:
				return ((InternalEList<?>)getSemesterInSpecialisation()).basicRemove(otherEnd, msgs);
		}
