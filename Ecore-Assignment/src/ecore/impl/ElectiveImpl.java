...
public class ElectiveImpl extends MinimalEObjectImpl.Container implements Elective {
	...
	public NotificationChain basicSetCourse(Course newCourse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EcorePackage.ELECTIVE__COURSE, oldCourse, newCourse);
	...
	public void setCourse(Course newCourse) {
		if (newCourse != course) {
			...
			if (course != null)
				msgs = ((InternalEObject)course).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EcorePackage.ELECTIVE__COURSE, null, msgs);
			if (newCourse != null)
				msgs = ((InternalEObject)newCourse).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EcorePackage.ELECTIVE__COURSE, null, msgs);
			msgs = basicSetCourse(newCourse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.ELECTIVE__COURSE, newCourse, newCourse));
	}
